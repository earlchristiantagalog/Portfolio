            ...
            <div className="space-y-4">
              <div className="group flex items-start gap-4 rounded-2xl border border-card-border bg-card p-5 shadow-sm transition-all hover:shadow-md">
                ...
                <div>
                  ...
                  <a href={`mailto:${social.email}`} className="text-sm text-muted-foreground transition-colors hover:text-primary">
                    {social.email}
                  </a>
                </div>
              </div>
              ...
              <div className="group flex items-start gap-4 rounded-2xl border border-card-border bg-card p-5 shadow-sm transition-all hover:shadow-md">
                ...
                <div>
                  ...
                  <a href={social.github} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground transition-colors hover:text-primary">
              ...
              <div className="group flex items-start gap-4 rounded-2xl border border-card-border bg-card p-5 shadow-sm transition-all hover:shadow-md">
                ...
                <div>
                  ...
                  <a href={social.linkedin} target="_blank" rel="noopener noreferrer" className="text-sm text-muted-foreground transition-colors hover:text-primary">
