          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {about.bio.map((paragraph, i) => (
                <p key={i} className="max-w-prose leading-relaxed text-muted-foreground">
                  {paragraph}
                </p>
              ))}
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2.5">
                {about.skills.map((skill) => (
                  <span
                    key={skill}
                    className="inline-flex items-center rounded-xl border border-card-border bg-card px-3 py-1.5 text-xs font-medium text-foreground shadow-sm transition-all hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-md sm:px-4 sm:py-2 sm:text-sm"
                  >
                    {skill}
                  </span>
                ))}
